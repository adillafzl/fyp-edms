...
<div class="title" style="text-align: left;">
    MEMOHON CUTI BEREHAT SELAMA <?php echo nl2br($days); ?> HARI
</div>
<br><br><br>
...
<div class="note" style="text-align: left;">
    Saya <?php echo nl2br($fname); ?>, <?php echo nl2br($id); ?> memohon kebenaran cuti selama <?php echo nl2br($days); ?>
     hari iaitu pada pada <?php echo nl2br($datea); ?> hingga <?php echo nl2br($dateb); ?>. 
</div>
<br>
<div class="note" style="text-align: left;">
    2. Saya mendapati saya <?php echo nl2br($reason); ?> pada awal pagi <?php echo nl2br($datea); ?>.
    Saya tidak mendapat rawatan daripada doktor tetapi rehat di rumah.
</div>
<br>

<div class="note" style="text-align: left;">
    3. Saya terpaksa memohon cuti pada <?php echo nl2br($datea); ?>. Saya akan balik semula ke tempat kerja pada <?php echo nl2br($edate); ?>.
</div>
<br>
