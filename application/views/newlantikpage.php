  ...
  <body>
      <div class="container">
          <div class="table-wrapper">
            ...
            <form action="<?php echo site_url('lantik-form.php');?>" method="post">
                Templates :
                    </br></br>
                    <input type="radio"  name="lantikA" id="lantikA" >
                        <label for ="fyp"> Surat Pelantikan Jawatan Program</label></br>
