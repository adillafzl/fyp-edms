              ...
              <form action="<?php echo site_url('Newpage/insert');?>" method="post">
                ...
                Templates :
                    ...
                    <input type="radio"  name="temp" >
                        <label for ="blank"> Surat Cuti </label></br>

                    <input type="radio"  name="temp" >
                        <label for ="pgh"> Surat FYP </label></br>

                    <input type="radio"  name="temp" >
                        <label for ="lantik"> Surat Latihan Industri (LI) </label></br>

                    <input type="radio"  name="temp" >
                        <label for ="aduan"> Surat Perlantikan </label></br>
                    </br>
