...
<div class="signup-form">
    <form action="<?php echo site_url('Register/insert');?>" method="post">
		<h2>Register</h2>
		<p class="hint-text">Create your new account here</p>
        ...
        <div class="form-group">
        	<input type="text" class="form-control" name="icnum" placeholder="IC Number" required="required">
        </div>
		<div class="form-group">
	...
	<div class="text-center">Already have an account? <a href="./home">Sign in</a></div>
</div>
</body>
</html>                            