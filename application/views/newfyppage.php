  ...
  <body>
      <div class="container">
          <div class="table-wrapper">
            ...
            <form action="<?php echo site_url('Newpage/fypp');?>" method="post">
                Templates :
                    </br></br>
                    <input type="radio"  name="fypA" id="fypA" >
                        <label for ="fyp"> Surat Pelantikan Penyelia FYP</label></br>

                    <input type="radio"  name="fypB" id="fypB">
                        <label for ="fyp"> Surat Pelantikan Pemeriksa FYP</label></br>
